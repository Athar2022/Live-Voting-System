<template>
  <div class="max-w-6xl mx-auto">
    ...
    <div v-else-if="error" class="card text-center py-12">
      ...
      <h3 class="text-xl font-semibold text-gray-900 mb-2">Unable to Load Results</h3>
    ...
    <div v-else-if="results" class="space-y-6">
      ...
      <div class="card">
        <div class="card-body p-6">
          <div class="flex justify-between items-start mb-4">
            <div class="flex-1">
              <h1 class="text-3xl font-bold text-gray-900 mb-2">{{ results.poll.title }}</h1>
          ...
          <!-- User Vote Indicator -->
          <div v-if="results.userVote" class="bg-primary-50 border border-primary-200 rounded-lg p-4 mt-4">
      ...
      <div class="card">
        <div class="card-body p-6">
          <h2 class="text-2xl font-bold text-gray-900 mb-6">Vote Distribution</h2>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="card">
          <div class="card-body p-6">
            <h3 class="text-xl font-bold text-gray-900 mb-4">Detailed Breakdown</h3>
            <div class="space-y-4">
              <div 
          ...
          <div class="card-body p-6">
            ...
            <div class="space-y-4">
              <div class="flex justify-between items-center py-3 border-b border-gray-200">
                ...
                <span class="font-medium text-gray-900">{{ results.poll.totalVotes }}</span>
              </div>
              <div class="flex justify-between items-center py-3 border-b border-gray-200">
              ...
              <div v-if="leadingOption" class="bg-green-50 border border-green-200 rounded-lg p-4 mt-4">
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p class="text-green-700">{{ leadingOption.text }} ({{ leadingOption.percentage }}%)</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div v-if="!results.poll.isClosed && socketStore.isConnected" class="flex items-center justify-center space-x-2 text-sm text-green-600">
...
export default {
  ...
  setup() {
    ...
    const closePoll = async () => {
      if (!confirm('Are you sure you want to close this poll? This will stop all voting.')) {
        return
      }
    ...
    const chartData = computed(() => {
      ...
      return {
        labels: results.value.options.map((opt, index) => 
    ...
    const getUserVoteText = (selectedOptions) => {
      ...
      return selectedOptions
        .map(index => `${String.fromCharCode(65 + index)}. ${results.value.options[index].text}`)
        .join(', ')
    }
